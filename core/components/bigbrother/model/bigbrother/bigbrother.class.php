...
class BigBrother
{
    ...
    function __construct(modX &$modx, array $config = array())
    {
        ...
        $this->config = array_merge(array(
            ...
            'mgr_template_path' => $core . 'partials/',
    ...
    public function loadOAuth()
    {
        ...
        if($oauthSecret != null && $oauthSecret != '')
        {
    ...
    /**
     * Helper method to retrieve a bigbrother related system setting
     *
     * @access public
     * @param string  $key       The setting name
     * @param boolean $checkUser Whether to check the user setting used to override an account for reports
     ...
     * @param array  $limit
     * @access public
     * @return string $url The url to retrieve reports from or to build the cached result set
     */
