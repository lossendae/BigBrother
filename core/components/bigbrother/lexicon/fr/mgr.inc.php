...
$_lang['bigbrother.class_simplexml'] = '<strong>Il semblerait que <a href="http://us3.php.net/manual/en/book.simplexml.php">SimpleXML</a> ne soit pas compilé dans votre version de PHP. <br/> Il est requis par le plugin pour fonctionner correctement.</strong>';
$_lang['bigbrother.function_curl'] = '<strong>Il semblerait que <a href="http://www.php.net/manual/en/book.curl.php">cURL</a>  ne soit pas compilé dans votre version de PHP. <br/> Il est requis par le plugin pour fonctionner correctement.</strong>';
